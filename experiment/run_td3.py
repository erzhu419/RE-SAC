"""
Wrapper for DSAC's td3.py that injects gym_patch before import.
Run as: python run_td3.py --config configs/td3-normal/hopper.yaml --gpu 0 --seed 0
"""
import sys
import os
...
import runpy
runpy.run_path(os.path.join(DSAC_ROOT, 'td3.py'), run_name='__main__')
